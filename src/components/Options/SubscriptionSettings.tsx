                ...
                <button className={styles.upgradeButton}>
                    <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            ...
                            <stop offset="0%" stop-color="#A32CC4" />
                            <stop offset="25%" stop-color="#C1208F" />
                            <stop offset="50%" stop-color="#F1203C" />
                            <stop offset="75%" stop-color="#FF6026" />
                            <stop offset="100%" stop-color="#FFAB36" />
                            </linearGradient>
                        </defs>
                        <path
