...
export default async function GameResult({ gameId, mortSubite }: { gameId: string, mortSubite?: boolean }) {
            ...
            <div className={styles.finalScore}>
                ...
                <div className={styles.btnContainerList}>
                    ...
                    <div className={styles.btnList}>
                        ...
                        {user?.id !== gameData?.user_id && <ReplayButton gameId={gameId} mortSubite={mortSubite}>Défier</ReplayButton>}
                        {/* If the user is the game owner, render differents buttons */}
                        {user?.id === gameData?.user_id && <ReplayButton gameId={gameId} mortSubite={mortSubite}>Recommencer</ReplayButton>}                        {user?.id === gameData?.user_id && <Link href="/game/karakaku">
