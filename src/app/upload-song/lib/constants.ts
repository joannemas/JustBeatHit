export const MAX_MP3_SIZE_MB = 500
export const MAX_COVER_SIZE_MB = 5
export const MAX_LRC_SIZE_MB = 1
export const ACCEPTED_IMAGE_TYPES = ["image/jpeg", "image/png", "image/webp", "image/jpg"]

export const difficultyLevels = ['Facile', 'Moyen', 'Difficile', 'Impossible'] as const
export const statusOptions = ['Draft', 'Live'] as const
